	...
	<body>
		...
		<div class="container">
	      	<form class="form-signin" action="/Users/register" method="post">
		        ...
		        <input type="text" name="billing_street" class="form-control" placeholder="Name" required>
		        <label>Billing City:</label>
		        <input type="text" name="billing_city" class="form-control" placeholder="Name" required>
		        <label>Billing State:</label>
		        <input type="text" name="billing_state" class="form-control" placeholder="Name" required>
		        <label>Billing Zipcode:</label>
		        <input type="text" name="billing_zip" class="form-control" placeholder="Name" required>
		        <div class="checkbox">
		        </div>
